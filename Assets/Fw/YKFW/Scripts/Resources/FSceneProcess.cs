...
namespace FW
{
    internal class FSceneProcess : HandleBase
    {
        ...
        public void ProcessComplete()
        {
            ...
            FEventManager.Inst.DispatchEvent(FrameDef.SceneProcessType.SceneLoaded, Name);
        ...
        private IEnumerator _loadScene(string name)
        {
            ...
            {
                string _finalPath = FResourceCommon.GetURLPath("StreamingResources/" + Info.LoadPath,
                ...
                ProcessState = FrameDef.AsyncState.LoadEnd;
                afterLoad();
