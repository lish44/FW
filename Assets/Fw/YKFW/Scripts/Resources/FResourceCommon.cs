...
namespace FW
{
    ...
    public class FResourceCommon
    {
        ...
        public static string GetFileSuffix(string resPathName)
        {
            ...
            return resPathName.Substring(index, resPathName.Length - index);
        }
        ...
        public static string DeletSuffix(string resPathName)
        {
            ...
            return resPathName.Substring(0, index);
        }
        ...
        public static string GetURLPath(string p_filename, string PreFix, string Suffix)
        {
            ...
            if (Application.platform == RuntimePlatform.OSXEditor)
                path = Application.temporaryCachePath + "/GameRes/" + p_filename;

            if (Application.platform == RuntimePlatform.IPhonePlayer)
                path = FResourcesManager.RESROOT + p_filename;
        ...
        /// 根据平台获得对应的包内流媒体文件路径
        /// </summary>
        public static string GetStreamingAssetsPath(string p_filename, string suffix = "")
        {
            ...
            return STREAMING_ASSET_PATH + "/" + p_filename + suffix;
        }
